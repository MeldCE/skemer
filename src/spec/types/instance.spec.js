...
var suites = [
  {
    ...
    results: [
      ...
      {
        label: 'should return the original instance',
        input: ['proto', 'undef', false],
        result: proto1
      },
      {
        label: 'should throw on a non-instance value',
        input: [false, 'invalid', false],
        throws: new errors.DataTypeError('Value must be a TestPrototype')
      },
      {
        label: 'should return new instance',
  ...
  },
  {
    ...
    results: [
      {
        label: 'should throw SchemaError on bad prototype',
        input: [false, 'proto', false],
